"""
Django settings for patient_snowflake_d_78761 project.
...
ROOT_URLCONF = 'patient_snowflake_d_78761.urls'
...
WSGI_APPLICATION = 'patient_snowflake_d_78761.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_snowflake_d_78761 API",
    "DESCRIPTION": "API documentation for patient_snowflake_d_78761 App",
    "VERSION": "v1",
}
