...
## Project Structure
    ...
    ├── patient_snowflake_d_78761  # Django project configurations
...
1. Clone this repo and `cd patient_snowflake_d_78761`
...
2. Clone this repo and `cd patient_snowflake_d_78761`
